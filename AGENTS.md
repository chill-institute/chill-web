...
| User workflows              | `pnpm exec vp run e2e`                                                        | local, [CI](./.github/workflows/_e2e.yml) on PRs                                                                                                   | Playwright report; artifact `playwright-artifacts`                              |
...
| Deploy                      | `main` push: build, `pnpm exec vp run smoke`, SHA-256 manifest, `sst deploy`  | [CI](./.github/workflows/main.yml)                                                                                                                 | artifacts `web-app-<env>-<run>`, `playwright-<env>-<run>`; deployed release SHA |
