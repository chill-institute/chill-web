...
function NativeSelect({ className, wrapperClassName, children, ...props }: NativeSelectProps) {
  return (
    <span
      ...
      className={cn(
        "inline-grid w-full grid-cols-[1fr_--spacing(8)] items-center",
        wrapperClassName,
      )}
    >
      <select
      ...
      <ChevronDownIcon
        aria-hidden="true"
        className="pointer-events-none col-start-2 row-start-1 size-4 place-self-center text-fg-2 dark:text-fg-3"
      />
    </span>
  );
}
